...
@WebServlet("/MessageRecvDetailC")
public class MessageRecvDetailC extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("duo/message_recvdetail.jsp").forward(request, response);
