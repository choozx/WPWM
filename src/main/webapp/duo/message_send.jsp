...
<body>
	<div class="container bootdey">
				...
				<form action="MessageSendC?nickname=${sessionScope.accountInfo.nickname}" method="post" onsubmit="return confirmMessage()" name="messageform">
					<div class="form-row mb-3" >
						<label for="to" class="col-2 col-sm-1 col-form-label">- 보내는사람 &nbsp; &nbsp;: ${sessionScope.accountInfo.nickname }  </label>
					</div>
					<div class="form-row mb-3">
						<label for="cc" class="col-2 col-sm-1 col-form-label">- 받는사람 &nbsp; &nbsp; &nbsp; : <input placeholder="받는사람을 입력하세요" required="required" name="recvN">  </label>
					</div>
				<p></p>
