...
<body>
	<form action="DuoRegC?name=${sessionScope.accountInfo.nickname }" method="post" onsubmit="return duoRegCheck();" name="duoRegForm">
		<table id="duoRegTbl" align="center" border="1">
			<tr>
				<td colspan="2"><h3 style="color: white;">소환사 등록하기</h3></td>
			</tr>
			<tr>
				<td class="duoreg-td01" colspan="2">소환사 이름</td>
			</tr>
			<tr>
				<td class="duoreg-td02" colspan="2" style="color: white;">${sessionScope.accountInfo.nickname }</td>
			</tr>
			<tr>
				<td class="duoreg-td01">주 포지션</td>
				<td class="duoreg-td01">큐 타입</td>
			<tr>
				<td class="duoreg-td02"><select name="position"
					style="width: 100%">
				...
				<td class="duoreg-td02"><select name="queue" style="width: 100%">
			...
			<tr>
				<td class="duoreg-td02" colspan="2"><textarea name="duoMemo"
						style="width: 100%; height: 100%" placeholder="3글자 이상 입력하세요" maxlength="80" ></textarea></td>
			</tr>
			<tr>
				<td class="duoreg-td01">삭제 비밀번호</td>
				<td class="duoreg-td02"><input name="duoPw" style="width: 95%"
