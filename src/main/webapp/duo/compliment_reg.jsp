...
<body>
	...
	<form action="ComplimentRegC?nickname=${sessionScope.accountInfo.nickname }" method="post" onsubmit="return duoRegCheck();" name="duoRegForm">
		<table id="duoRegTbl" align="center" border="1">
			<tr>
				<td colspan="2"><h3 style="color: white;">칭찬하기</h3></td>
			</tr>
			<tr>
				<td class="duoreg-td01" colspan="2">소환사 이름</td>
			</tr>
			<tr>
				<td class="duoreg-td02" colspan="2" style="color: white;"><input name="name" style="width: 100%; height: 100%" placeholder="칭찬할 닉네임을 입력하세요"></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="duoreg-td02" colspan="2"><textarea name="CMemo"
						style="width: 100%; height: 100%;" placeholder="칭찬할 내용을 입력하세요" maxlength="80"></textarea></td>
			</tr>
			<tr>
