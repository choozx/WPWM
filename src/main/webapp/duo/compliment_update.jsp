...
<body>
	...
	<form action="ComplimentUpdateC" method="post" name="duoUpdateForm" onsubmit="return CUpdateCheck();">
		<table id="duoRegTbl" align="center" border="1">
			<tr>
				<td colspan="2"><h3 style="color: white;">수정하기</h3></td>
			</tr>
			<tr>
				<td class="duoreg-td01" colspan="2">소환사 이름</td>
			</tr>
			<tr>
				<td class="duoreg-td02" colspan="2" style="color: white;">${compliment.name}</td>
			</tr>
			<tr>
				<td class="duoreg-td01" colspan="2">메모</td>
			</tr>
			<tr>
				<td class="duoreg-td02" colspan="2"><textarea name="CMemo"
						style="width: 100%; height: 100%;" placeholder="칭찬할 내용을 입력하세요" maxlength="80">${compliment.memo}</textarea></td>
			</tr>
			<tr>
				<td class="duoreg-td01">삭제 비밀번호</td>
				<td class="duoreg-td02"><input name="CPw" style="width: 95%"
			...
			<tr>
				...
				<td class="duoreg-td02"><button class="btn_duoreg02" id="btn_duoreg02" name="no" value="${compliment.no}">등록</button></td>
			</tr>
		</table>
	</form>
