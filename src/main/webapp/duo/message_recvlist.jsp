...
<body>
	<div>
		<p class="text-center02">
			...
			받은쪽지함 <span><a class="message-menu02"
		...
		<div id="board_list_wrap1">
			<div id="board-list">
				<form
					...
					method="post" onsubmit="return confirm('정말 삭제하시겠습니까?')" type="submit" >
				...
				<c:forEach var="m" items="${Recvmessages }" varStatus="status">
					<form action="MessageDelController?no=${m.no}" method="post" onsubmit="return confirm('정말 삭제하시겠습니까?')" type="submit" >
						<div id="board-list-body">
							<c:choose>
								...
								'width=430,height=400,left=1100,top=0,scrollbar=yes');">쪽지보내기</button>
										</div>
										<div id="m4"
