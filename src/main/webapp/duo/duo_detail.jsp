...
<body>
	<form action="DuoUpdateC" method="post">
		<table id="duoRegTbl" align="center" border="1">
			<tr>
				<td colspan="2"><h3 style="color: white;">듀오 찾기</h3></td>
			</tr>
			<tr>
				<td class="duodetail-td01" colspan="2">소환사 이름</td>
			</tr>
			<tr>
				<td class="duodetail-td02" colspan="2" align="left" style="color: white;">${duo.name}</td>
			</tr>
			<tr>
				<td class="duodetail-td01">주 포지션</td>
				<td class="duodetail-td01">큐 타입</td>
			<tr>
				<td class="duodetail-td02" style="color: white;">${duo.position}</td>
				<td class="duodetail-td02" style="color: white;">${duo.type}</td>
			</tr>
			
			<tr>
				<td class="duodetail-td01" colspan="2">메모</td>
			</tr>
			<tr>
				<td class="duodetail-td02" colspan="2" style="color: white;">${duo.memo}</td>
			</tr>
		</table>
	</form>
